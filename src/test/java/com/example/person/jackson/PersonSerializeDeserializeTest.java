...
public class PersonSerializeDeserializeTest {
    ...
    static void setup() {
        ...
        simpleSerializer.addSerializer(Person.class, new PersonSerializer());
        mapper.registerModule(simpleSerializer);
    }

    @Test
    void roundtripPerson() throws IOException {
        try (final var res = PersonSerializeDeserializeTest.class
